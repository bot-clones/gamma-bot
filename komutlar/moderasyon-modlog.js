...
exports.run = async(client, message, args) => {
  if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<a:iptal:760154725990531074>Bu komutu kullanabilmek için "\`Yönetici\`" yetkisine sahip olmalısın.`);
