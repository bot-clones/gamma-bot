...
exports.run = async(client, message, args) => {
  ...
  if(panel) return message.channel.send(`Bu sunucuda panel zaten ayarlanmış! Devredışı bırakmak için;  \`${prefix}panel-kur sil\``)
      ...
      message.channel.send(new Discord.RichEmbed().setColor('#fffff0').setTitle('Sunucu Panel').setDescription('Gerekli dosaylar kurulsun mu?.').setFooter('Onaylıyorsan 15 saniye içerisinde "evet" yazmalısın.'))
.then(() => {
